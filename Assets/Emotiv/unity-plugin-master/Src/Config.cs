namespace EmotivUnityPlugin
{
    ...
    public static class Config
    {
        ...
        public static string AppClientId            = "com.hexasiel.unity";
        public static string AppClientSecret        = "kMOHbjPtmm39mVUADktwWNV9sAL0DJ4j4ntgieN2cSqgVBcez6MaL3OyZB48ewfR7k6BIsX4X4Cv8okH3Ld54reOW0iqxlZAO2UWXOKw579phmU6moN4hzH0yhmJmmxy";

         public static string AppUrl                 = "wss://localhost:6868"; // default
        public static string AppVersion             = "3.5.4"; // default
