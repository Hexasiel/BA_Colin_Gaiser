...
namespace EmotivUnityPlugin {
    ...
    public class EmotivUnityItf {
        ...
        public void Init(string clientId, string clientSecret, string appName,
            ...
            //Catch Events in case there is no subscription
            MotionDataReceived += OnMotionData;
            EEGDataReceived += OnEEGData;
            DevDataReceived += OnDevData;
            PerfDataReceived += OnPerfData;
            BandPowerDataReceived += OnBandPowerData;
            SysEventsReceived += OnSysEvents;
            MentalCommandReceived += OnMentalCommand;
            FacialExpReceived += OnFacialExp;
        ...
        private void OnBandPowerDataReceived(object sender, ArrayList e) {
            ...
            BandPowerDataReceived(sender, e);
        }
        private void OnBandPowerData(object sender, ArrayList e) {
        ...
        private void OnPerfDataReceived(object sender, ArrayList e) {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            PerfDataReceived(sender, e);
        }
        private void OnPerfData(object sender, ArrayList e) {
        ...
        private void OnDevDataReceived(object sender, ArrayList e) {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            DevDataReceived(sender, e);
        }
        private void OnDevData(object sender, ArrayList e) {
        ...
        private void OnMotionDataReceived(object sender, ArrayList e) {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            MotionDataReceived(sender, e);
        }
        private void OnMotionData(object sender, ArrayList e) {
        ...
        private void OnEEGDataReceived(object sender, ArrayList e) {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            EEGDataReceived(sender, e);
        }
        private void OnEEGData(object sender, ArrayList e) {
        ...
        private void OnSysEventsReceived(object sender, SysEventArgs data) {
            ...
            SysEventsReceived(sender, data);
        }
        private void OnSysEvents(object sender, SysEventArgs data) {
        ...
        private void OnMentalCommandReceived(object sender, MentalCommandEventArgs data) {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            MentalCommandReceived(this, data);
        }
        private void OnMentalCommand(object sender, MentalCommandEventArgs data) {
        ...
        private void OnFacialExpReceived(object sender, FacEventArgs data) {
            ...
            UnityEngine.Debug.Log(dataText);
            m_facExpData = data;
            FacialExpReceived(this, data);
        }

        public FacEventArgs m_facExpData;
